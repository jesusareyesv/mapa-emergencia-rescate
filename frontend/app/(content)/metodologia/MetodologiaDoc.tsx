...
const HERO = (
  <DocHero
    pill="Datos en vivo · al corte"
    title="Unificación de reportes de personas desaparecidas"
  >
    <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80 sm:text-lg">
      Reporte técnico de metodología, arquitectura y resultados. Documenta el
      pipeline de resolución de entidades (<em>record linkage</em>) y la
      verificación biométrica facial que consolida reportes heterogéneos de
      múltiples fuentes en una identidad canónica por persona, preservando el
      linaje del dato y minimizando los falsos positivos.
    </p>
    ...
    <p className="mt-3 text-xs text-white/50">
      Última actualización: {LAST_UPDATED}. Las cifras de reconocimiento facial
      aumentan mientras el proceso continúa.
    </p>
  </DocHero>
);

export default function MetodologiaDoc() {
  return (
    <DocLayout hero={HERO} toc={TOC}>
      <Callout variant="todos" title="Síntesis">
        <p>
          ...
          múltiples veces con variantes ortográficas del nombre, distinto orden
          de tokens y cobertura parcial de fotografía. El sistema ejecuta una{" "}
          <strong>resolución de entidades</strong> que consolida todos los
          registros en una <strong>ficha canónica por persona</strong>, con
          linaje completo y sin fusiones espurias entre identidades distintas.
        </p>
      </Callout>
      ...
      <Section id="resumen" eyebrow="01 · Visión general" title="Resumen ejecutivo">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            La redundancia inter-fuente es elevada: una misma entidad se repite
            con variantes de nombre, permutación del orden de tokens y cobertura
            parcial de foto.
          </li>
          <li>
          ...
          <li>
            ...
            probabilístico (cédula, hash de imagen, teléfono+apellido, nombre con
            corroboración) y (2) <strong>verificación biométrica</strong> por
            embeddings faciales.
          </li>
          <li>
            Esquema <strong>no destructivo</strong>: cada registro de origen se
            conserva inmutable y toda fusión es <strong>reversible</strong> vía
            linaje (<em>provenance</em>).
          </li>
          <li>
      ...
      <Section id="datos" eyebrow="02 · Datos" title="Snapshot de los datos">
        <p>
          ...
          independientes</strong>. Cada reporte se persiste sin transformación
          en una capa cruda inmutable (<code>source_record</code>); el pipeline
          de unificación opera sobre proyecciones normalizadas, nunca sobre el
          dato original.
        </p>
        ...
        <Callout variant="todos">
          <p>
            ...
            consolidan. Más de la mitad del universo ya tiene embedding facial
            asociado.
          </p>
        </Callout>
      </Section>
      ...
      >
        <p>
          La arquitectura combina componentes estándar de la industria, cada uno
          especializado: almacenamiento relacional para el modelo de
          identidades, un índice vectorial para búsqueda de vecinos más cercanos
          (<em>ANN</em>) sobre embeddings faciales, y los modelos de visión por
          computadora para detección y reconocimiento.
        </p>
        <TableWrap>
          <thead>
            <tr>
        ...
        <Callout variant="tecnico">
          <p>
            Modelo de 3 capas en PostgreSQL: <code>source_record</code> (crudo
            inmutable) → <code>persona</code> (normalizada con claves fonéticas
            ...
            (colección de 512-d, distancia coseno). Indexado facial multiproceso
            fijando 1 hilo de ONNX por núcleo. Idempotencia por{" "}
            <code>(fuente, id)</code> y hash de dataset. Nada se borra; uniones
            reversibles vía procedencia.
          </p>
        </Callout>
      </Section>
      ...
      >
        <p>
          ...
          suficiente y se aplica en orden decreciente de fiabilidad de la señal.
          El criterio es conservador —se prioriza{" "}
          <strong>precisión sobre recall</strong>—: ante ambigüedad{" "}
          <strong>no se fusiona</strong>, porque un falso positivo colapsa dos
          identidades distintas y elimina de facto a una persona del registro, el
          error de mayor costo en este dominio.
        </p>
        ...
        <ol className="space-y-4">
          <li>
            ...
            <p>
              ...
              (<code>source_record</code>). Constituye la base de auditoría y la
              condición que hace toda fusión reversible.
            </p>
          </li>
          <li>
            <p className="font-semibold text-[var(--etext)]">
            ...
            <p>
              ...
              <em>case folding</em> y eliminación de diacríticos, segmentación de
              nombre/apellido, normalización telefónica a <strong>E.164</strong>{" "}
              y derivación de <strong>claves fonéticas</strong> (Double
              Metaphone/Soundex) que colapsan variantes homófonas. Ej.: «José» y
              «jose» convergen a la misma clave de bloqueo.
            </p>
          </li>
          <li>
            <p className="font-semibold text-[var(--etext)]">
            ...
            <p>
              Se fusionan registros que coinciden en un identificador específico
              y de alta fiabilidad:
            </p>
            <ol className="mt-1 list-decimal space-y-1 pl-5">
              <li><strong>Cédula</strong> idéntica.</li>
              <li>
                <strong>Hash de imagen</strong> idéntico (mismo archivo, aunque
                resida en otro host/CDN).
              </li>
              <li>
          ...
          <li>
            ...
            <p>
              Ante coincidencia de nombre con orden de tokens permutado («Pérez
              Juan» ≈ «Juan Pérez»), la fusión requiere al menos un atributo
              corroborante —misma <strong>zona</strong> o{" "}
          ...
          <li>
            ...
            <p>
              ...
              fusionan de forma automática: se aíslan para revisión. La decisión
              humana es soberana y persiste sobre cualquier reprocesamiento
              posterior.
            </p>
          </li>
          <li>
            ...
            <p>
              Al consolidar un clúster se construye una única ficha seleccionando,
              por atributo, el mejor valor disponible (estrategia tipo{" "}
              <em>MDM</em>): nombre más completo, foto de mayor calidad, cédula,
              ubicación y estado (buscado/encontrado).
            </p>
          </li>
        </ol>
        ...
        <Callout variant="warn" title="Lo que NO hacemos">
          <p>
            No se fusiona por nombre aislado (homónimos) ni por identificadores
            de baja entropía (p. ej. teléfonos <em>placeholder</em> como{" "}
            <code>+0000000</code> compartidos por cientos de registros). Esas
            señales generan clústeres degenerados («súper-grupos») que mezclan
      ...
      >
        <p>
          <strong>Principio:</strong> cuando dos registros disponen de foto, la
          verificación biométrica compara los rostros para confirmar
          co-referencia de identidad, incluso ante divergencia textual o datos
          faltantes. Es la capa de evidencia complementaria al{" "}
        ...
        <TableWrap>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className={TD}>
                Normaliza la pose mediante 106 puntos faciales, garantizando una
                representación invariante a la orientación.
              </td>
            </tr>
            <tr>
        ...
        <ol className="list-decimal space-y-1.5 pl-5">
          ...
          <li>
            Se consulta por <strong>similitud coseno</strong> contra el corpus
            (búsqueda <em>ANN</em>), obteniendo un score en [0, 1].
          </li>
        </ol>

        <h3 className="qi-h4 pt-2 text-[var(--etext)]">Umbral de decisión</h3>
        <TableWrap>
          <thead>
            <tr>
        ...
        <p className="text-sm text-[var(--etext3)]">
          El umbral operativo de fusión es <strong>51 %</strong> de similitud
          coseno, alineado con el del bot de verificación. En el survivorship, la
          ficha conserva el rostro de mayor calidad (resolución/nitidez) entre
          las coincidencias.
        </p>
        ...
        <Callout variant="warn">
          <p>
            ...
            <strong>no es infalible</strong>. Principales fuentes de error: alta
            similitud inter-clase entre parientes (fotos grupales/familiares);
            degradación de la señal (baja resolución, oclusión por
            lentes/gorra/mascarilla, baja iluminación); deriva morfológica en
            menores (el rostro cambia rápido entre tomas); gemelos; y{" "}
            <em>singletons</em> (una sola foto, sin par para corroborar).
          </p>
          <p>
            <strong>Mitigaciones:</strong> (1) umbral conservador (51 %); (2)
            banda de incertidumbre (45–51 %) excluida de la fusión automática;
            (3) arbitraje humano en el tablero con overlay de{" "}
            <em>bounding box</em> (verde = match, amarillo = no-match); (4)
            reversibilidad total. El facial acelera y corrobora; la decisión
            final en casos límite es humana.
          </p>
        </Callout>
      </Section>
      ...
      >
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            <strong>0 duplicados residuales</strong> verificables por las señales
            deterministas (hash de imagen, cédula, teléfono+apellido).
          </li>
          <li>
            Sin clústeres degenerados: la cardinalidad máxima de un clúster es{" "}
            <strong>33</strong> registros de una misma persona.
          </li>
          <li>
            Precisión del matching por nombre, auditada con panel multi-revisor:{" "}
            <strong>≥ 99 %</strong>.
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            ...
            inaccesibles (alojadas en un host privado bloqueado; localizadas en un{" "}
            <em>mirror</em> público) — actualmente en cola de extracción de
            embeddings.
          </li>
          <li>
            Etapa final: una pasada de fusión por similitud facial resolverá los
            casos que la evidencia textual no pudo confirmar (mismo rostro,
        ...
        <Callout variant="tecnico" title="Seguimiento en vivo">
          <p>
            El progreso es observable en el tablero: <em>throughput</em>, avance
            por etapa y la verificación facial caso por caso.
          </p>
        </Callout>
      </Section>

      {/* 7. Privacidad */}
      <Section id="privacidad" eyebrow="07 · Ética" title="Garantías y privacidad">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>No destructivo.</strong> Cada registro de origen se conserva
            inmutable; las fusiones son reversibles vía linaje.
          </li>
          <li>
            <strong>Conservador ante el error.</strong> La fusión exige
            evidencia; los casos de baja confianza pasan por arbitraje humano.
          </li>
          <li>
            <strong>Minimización de datos.</strong> No se exponen teléfonos ni
            datos de contacto; el uso es estrictamente asistivo de reunificación.
          </li>
          <li>
            <strong>Idempotencia.</strong> El reprocesamiento de una fuente no
            genera duplicados (clave natural <code>(fuente, id)</code> + hash de
            dataset).
          </li>
        </ul>
        <p className="text-sm">
      ...
      <Section id="glosario" eyebrow="08 · Referencia" title="Glosario">
        <dl className="space-y-3">
          <GlossaryItem term="Record linkage / resolución de entidades">
            Proceso de identificar y consolidar registros que refieren a la misma
            persona real.
          </GlossaryItem>
          ...
          <GlossaryItem term="Identidad canónica (golden record)">
            Registro consolidado que agrega todos los reportes de una persona bajo
            un <code>public_uid</code> estable.
          </GlossaryItem>
          ...
          <GlossaryItem term="Idempotencia">
            Propiedad por la cual reprocesar una misma fuente no produce registros
            duplicados.
          </GlossaryItem>
          <GlossaryItem term="Margen de error">
            Casos límite del reconocimiento facial (alta similitud inter-clase,
            degradación de señal, menores, gemelos, singletons).
          </GlossaryItem>
        </dl>
        ...
        <p className="mt-8 border-t border-[var(--eborder)] pt-6 text-xs text-[var(--etext3)]">
          ...
          <code>terremoto</code>. Las cifras de reconocimiento facial aumentan
